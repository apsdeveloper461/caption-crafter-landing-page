...
const Index = () => {
  ...
  return (
    <div className="min-h-screen theme-transition overflow-x-hidden">
      {/* Header */}
      <header
        className={`py-6 md:py-8 px-6 md:px-10 lg:px-20 flex justify-between items-center bg-background/80 dark:bg-background/70 backdrop-blur-sm sticky top-0 z-50 transition-all duration-300 ${
      ...
      >
        ...
        <nav
          className={`${
            ...
            isMobile
              ? "flex-col absolute top-full left-0 right-0 bg-background/95 backdrop-blur-md p-5 space-y-4 shadow-lg"
