...
const pricingPlans = [
  {
    ...
    cta: "Start for Free",
    ctaVariant: "outline",
    url: "https://captioncrafter.vercel.app/dashboard",
    popular: false
  },
  {
    name: "Pro Plan",
    ...
    cta: "Upgrade Now",
    url: "https://captioncrafter.vercel.app/dashboard/pricing",
    ctaVariant: "default",
    popular: true
  }
];
...
export const Pricing = () => {
  return (
    <section
      id="pricing"
      className="py-20 px-6 md:px-10 lg:px-20 relative theme-transition"
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
            ...
            Need more flexibility? Upgrade to Pro for unlimited captions and
            additional tools to boost your social game!
          </p>
        </div>
            ...
            >
              ...
              <p
                className={`text-3xl font-bold mb-6 ${
                  plan.popular ? "text-brand-purple" : "text-foreground"
                } relative z-10`}
              >
                {plan.price}
              </p>
              ...
              <a href={plan.url}  rel="noopener noreferrer">
                <Button
                  ...
                  className={`w-full py-6 hover-border-btn relative z-10 ${
                    plan.popular
