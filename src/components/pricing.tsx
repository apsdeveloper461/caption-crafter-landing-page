...
export const Pricing = () => {
  return (
    <section id="pricing" className="py-20 px-6 md:px-10 lg:px-20 bg-background/50 theme-transition">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <p className={`text-3xl font-bold mb-6 ${plan.popular ? 'text-brand-purple' : 'text-foreground'}`}>
                {plan.price}
              </p>
