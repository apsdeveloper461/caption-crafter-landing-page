...
export const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-20 px-6 md:px-10 lg:px-20 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {steps.map((step) => (
            <div 
              key={step.number}
              className="bg-white rounded-lg p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow relative"
            >
              <div className="absolute -top-4 -left-4 w-10 h-10 rounded-full gradient-bg flex items-center justify-center text-white font-bold">
                {step.number}
              </div>
